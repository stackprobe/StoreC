...
namespace Charlotte.Games.Enemies
{
	...
	public static class EnemyCatalog
	{
		...
		private static EnemyInfo[] Enemies = new EnemyInfo[]
		{
			...
			new EnemyInfo("テスト用/アイテム・武器-Bounce", () => new Enemy_Bアイテム(X, Y, Enemy_Bアイテム.効用_e.WEAPON_BOUNCE)),
			new EnemyInfo("テスト用/アイテム・武器-Spread", () => new Enemy_Bアイテム(X, Y, Enemy_Bアイテム.効用_e.WEAPON_SPREAD)),
