...
namespace Charlotte.Games.Enemies
{
	...
	public static class EnemyCatalog
	{
		...
		private static EnemyInfo[] Enemies = new EnemyInfo[]
		{
			...
			new EnemyInfo("テスト用/アイテム・ノーマル", () => new Enemy_Bアイテム(X, Y, Enemy_Bアイテム.効用_e.WEAPON_B_NORMAL)),
			new EnemyInfo("テスト用/アイテム・ファイアボール", () => new Enemy_Bアイテム(X, Y, Enemy_Bアイテム.効用_e.WEAPON_B_FIRE_BALL)),
			new EnemyInfo("テスト用/アイテム・レーザー", () => new Enemy_Bアイテム(X, Y, Enemy_Bアイテム.効用_e.WEAPON_B_LASER)),
			new EnemyInfo("テスト用/アイテム・波動ビーム", () => new Enemy_Bアイテム(X, Y, Enemy_Bアイテム.効用_e.WEAPON_B_WAVE_BEAM)),
